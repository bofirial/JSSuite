...
using JS.Suite.JamesAndJenniferWedding.Models.GuestBook;
using System;
...
namespace JS.Suite.JamesAndJenniferWedding.Controllers
{
    ...
    {
        private WeddingSites weddingSite = WeddingSites.JenniferAndJamesWedding;
        ...
        //        else
        //        {
        ////            appMessageResult = AppMessenger.Current.Send(MessageTypes.JenniferAndJamesWeddingComment,
